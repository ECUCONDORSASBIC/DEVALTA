 ...
 * Especializado en: Infrastructure, CI/CD, Monitoring, Security
 */

import { BaseTechnicalAgent } from './base-agent.js';

export class DevopsEngineerAgent extends BaseTechnicalAgent {
  constructor() {
    super('devops_engineer', {
  ...
  async analyzeCode(code, language) {
    // Análisis específico para Infrastructure, CI/CD, Monitoring, Security
