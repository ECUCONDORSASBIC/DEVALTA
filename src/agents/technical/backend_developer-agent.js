 ...
 * Especializado en: Node.js, TypeScript, APIs, Databases
 */

import { BaseTechnicalAgent } from './base-agent.js';

export class BackendDeveloperAgent extends BaseTechnicalAgent {
  constructor() {
    super('backend_developer', {
  ...
  async analyzeCode(code, language) {
    // Análisis específico para Node.js, TypeScript, APIs, Databases
