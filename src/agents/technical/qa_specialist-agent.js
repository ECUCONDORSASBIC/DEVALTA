/**
 * QA Specialist Agent
 * Especializado en: Testing, Quality Assurance, Automation
 */

import { BaseTechnicalAgent } from './base-agent.js';

export class QaSpecialistAgent extends BaseTechnicalAgent {
  constructor() {
    super('qa_specialist', {
  ...
  async analyzeCode(code, language) {
    // Análisis específico para Testing, Quality Assurance, Automation
