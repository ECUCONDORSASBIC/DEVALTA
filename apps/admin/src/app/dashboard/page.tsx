        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <AlertTriangle className={`h-5 w-5 ${metrics.securityAlerts > 0 ? 'text-orange-500' : 'text-green-500'}`} />
            </div>
            <div className="flex items-end gap-2">
            ...
            <Badge className={metrics.securityAlerts > 0 ? 'bg-orange-100 text-orange-800' : 'bg-green-100 text-green-800'}>
        ...
        <Card className="lg:col-span-1">
          ...
          <CardContent>
            <SystemHealthMonitor
              ...
              onServiceClick={(service) => console.log('Service details:', service)}
            />
          </CardContent>
        </Card>
            ...
            <VitalSignsChart
              data={[
                { 
                  ...
                  bloodPressure: { systolic: metrics.serverUptime, diastolic: metrics.dataIntegrity },
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3 p-3 bg-green-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">Base de datos respaldada exitosamente - hace 2 horas</p>
                </div>
              </div>
              <div className="flex items-start gap-3 p-3 bg-blue-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">23 pacientes y 2 doctores se registraron hoy</p>
                </div>
              </div>
              <div className="flex items-start gap-3 p-3 bg-orange-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">Tiempo de respuesta elevado en el servidor API - hace 1 hora</p>
                </div>
              </div>
            </div>
          </CardContent>
      ...
      <div className="bg-gradient-to-r from-red-500 to-orange-600 rounded-xl p-6 text-white">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-red-100">Control total sobre la plataforma AltaMedica con herramientas avanzadas de monitoreo</p>
          </div>
