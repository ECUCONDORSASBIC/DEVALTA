            ...
            <div className="space-y-4">
              {appointments.slice(0, 3).map((appointment) => (
                <AppointmentCard
                  ...
                  onReschedule={() => console.log('Reagendar', appointment.id)}
                  onCancel={() => console.log('Cancelar', appointment.id)}
                  showActions={true}
                />
              ))}
            </div>
        ...
        <Card className="lg:col-span-1">
          ...
          <CardContent>
            <MedicalAIAssistant
              patient={null}
              symptoms={[]}
              onSuggestDiagnosis={(diagnosis) => console.log('Diagnóstico:', diagnosis)}
              onRecommendTreatment={(treatment) => console.log('Tratamiento:', treatment)}
              compact={true}
            />
          </CardContent>
        </Card>
