...
export default function JobApplicationsPage() {
  const { user } = useAuth()
  const [activeTab, setActiveTab] = useState<'my-applications' | 'job-search' | 'notifications'>('my-applications')
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {activeTab === 'my-applications' && (
          <MyJobApplications doctorId={doctorId} />
        )}
        ...
        {activeTab === 'job-search' && (
          <div className="bg-white border border-gray-200 rounded-lg p-8 text-center">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">
              Búsqueda de Empleos Médicos
            </h3>
            <p className="text-gray-600">
              Explora oportunidades laborales en hospitales, clínicas y centros médicos.
        ...
        {activeTab === 'notifications' && (
          <div className="bg-white border border-gray-200 rounded-lg p-8 text-center">
            ...
            <p className="text-gray-600">
              Recibe actualizaciones sobre el estado de tus aplicaciones,
              entrevistas programadas y mensajes de empresas.
            </p>
          </div>
        )}
      </div>
        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-green-100 mt-1">
              La comunicación en tiempo real con empresas está habilitada.
