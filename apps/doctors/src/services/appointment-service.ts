...
class AppointmentService {
    ...
    try {
      ...
      for (const docSnapshot of querySnapshot.docs) {
        ...
        try {
          ...
          console.warn(`Sin permisos para cita ${appointment.id}`);
        }
      }
  ...
  async rescheduleAppointment(
    ...
    try {
      ...
      console.log(`Cita ${appointmentId} reprogramada para ${newDateTime}`);
  ...
  async recordAppointmentOutcome(
    ...
    try {
      ...
      console.log(`Resultado registrado para cita ${appointmentId}`);

    } catch (error) {
      console.error('Error registrando resultado de cita:', error);
      throw error;
    }
  }
  ...
  private async processNoShowActions(appointmentId: string, appointment: Appointment): Promise<void> {
    ...
    console.log(`Procesando no-show para cita ${appointmentId}`);
  }
  ...
  private async processCompletionActions(appointmentId: string, appointment: Appointment): Promise<void> {
    ...
    console.log(`Procesando finalización de cita ${appointmentId}`);
  }
  ...
  private async createRecurringAppointments(baseAppointment: Omit<Appointment, 'id'>): Promise<string> {
    ...
    console.log('Creando serie de citas recurrentes');
  ...
  private async scheduleAutomaticNotifications(appointmentId: string, appointment: Appointment): Promise<void> {
    ...
    console.log(`Programando notificaciones para cita ${appointmentId}`);
  }
  ...
  private async scheduleFollowUpAppointment(originalAppointmentId: string, recommendedDate: string): Promise<void> {
    ...
    console.log(`Programando seguimiento para cita ${originalAppointmentId}`);
  }
  ...
  private async logAppointmentAudit(auditData: any): Promise<void> {
    // Registrar en auditoría
    console.log('Registrando auditoría de cita:', auditData);
  }
}
