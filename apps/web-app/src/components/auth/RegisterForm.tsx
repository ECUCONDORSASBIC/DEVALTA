...
export default function RegisterForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('🎭 [RegisterForm] Rol seleccionado:', formData.role);
      console.log('🚀 [RegisterForm] Preparando redirección en 3 segundos...');
      ...
      setTimeout(() => {
        ...
        console.log('➡️ [RegisterForm] Ejecutando redirección a:', redirectUrl);
