...
import { FileText, Scale, Users, Globe, AlertCircle, CheckCircle } from 'lucide-react';
        ...
        <div className="max-w-4xl mx-auto px-6 py-12">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Vigente desde: {new Date().toLocaleDateString('es-ES', { year: 'numeric', month: 'long', day: 'numeric' })}
            </p>
          </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-blue-800">
                  AltaMedica facilita la conexión entre pacientes y profesionales médicos certificados. 
                  No proporcionamos servicios médicos de emergencia. En caso de emergencia médica, 
                  llama inmediatamente al 911 o acude al servicio de urgencias más cercano.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                Al acceder o usar AltaMedica, aceptas estos términos de servicio y nuestra política de privacidad. 
                Si no estás de acuerdo con alguna parte de estos términos, no debes usar nuestros servicios.
              </p>
              <p className="text-gray-600 mb-4">
                Estos términos constituyen un acuerdo legal vinculante entre tú ("Usuario", "Paciente", "Médico", o "Empresa") 
                y AltaMedica S.A. de C.V. ("AltaMedica", "nosotros", "nuestro").
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-4">
                ...
                <li>Los médicos deben proporcionar credenciales válidas y licencia médica vigente</li>
                <li>Las empresas deben estar legalmente constituidas</li>
              </ul>

              <h3 className="text-xl font-semibold text-gray-800 mb-3">3.2 Información de la cuenta</h3>
              <ul className="list-disc pl-6 space-y-2 text-gray-600">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-3">4.2 Relación médico-paciente</h3>
              <p className="text-gray-600 mb-4">
                La relación médico-paciente existe únicamente entre el paciente y el médico tratante. 
                AltaMedica no practica medicina ni interfiere en el juicio médico profesional.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                Ofrecemos garantía de satisfacción de 30 días para nuevos usuarios. 
                Los reembolsos por consultas específicas se evalúan caso por caso.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                ...
                es propiedad de AltaMedica o sus licenciantes. No puedes copiar, modificar o distribuir 
                nuestro contenido sin autorización expresa.
              </p>
              <p className="text-gray-600 mb-4">
                Tu historial médico y datos personales siempre serán de tu propiedad. 
                Nos otorgas licencia limitada para usar esta información únicamente para proporcionarte servicios.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-600">
                ...
                <li>Nuestra responsabilidad máxima se limita a las tarifas pagadas en los últimos 12 meses</li>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                ...
                en los tribunales competentes de la Ciudad de México, renunciando a cualquier otro fuero.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                Podemos actualizar estos términos ocasionalmente. Te notificaremos sobre cambios materiales 
                con al menos 30 días de anticipación. El uso continuado después de las modificaciones 
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                Puedes terminar tu cuenta en cualquier momento. Nosotros podemos suspender o terminar 
                tu acceso si violas estos términos. La terminación no afecta obligaciones previas.
              </p>
            </section>
          </div>
          ...
          <div className="bg-purple-50 rounded-lg p-8 mt-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <a href="mailto:legal@altamedica.com" className="text-purple-600 hover:text-purple-700">
                  legal@altamedica.com
                </a>
              </div>
              <div>
                <h3 className="font-semibold text-gray-900 mb-2">Soporte General</h3>
                <a href="mailto:support@altamedica.com" className="text-purple-600 hover:text-purple-700">
