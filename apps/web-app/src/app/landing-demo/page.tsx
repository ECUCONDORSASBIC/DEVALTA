...
const useVideoCarousel = (videos: readonly HeroVideo[], interval = 8000) => {
  ...
  useEffect(() => {
    if (!isMounted || isPaused || videos.length <= 1) return;
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-slate-800 mb-6">
            Lo que Hace Único a ALTAMEDICA
          </h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div>
          ...
          <p className="text-xl text-slate-600 mb-8">
            Revoluciona la recolección de historiales médicos con nuestra
            tecnología inmersiva que combina IA, interfaces intuitivas y
            análisis predictivo para una atención personalizada.
          </p>
          ...
          <Button
            onClick={() => (window.location.href = "/anamnesis")}
              ...
              <div className="space-y-3">
                ...
                <div className="bg-emerald-50 rounded-lg p-3">
                  <div className="text-sm text-emerald-700">
                    <span className="font-medium">Síndrome Cardiovascular</span>{" "}
                    → Cardiólogo: 87%
                  </div>
  ...
  >
    ...
    <div className="relative max-w-4xl mx-auto text-center px-6">
      ...
      <p className="text-xl mb-10 text-sky-100 max-w-2xl mx-auto leading-relaxed">
        Miles de profesionales ya transformaron su práctica médica con
        ALTAMEDICA
      </p>
