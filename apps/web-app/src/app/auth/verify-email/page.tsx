      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-neutral-50 to-cyan-50 flex items-center justify-center p-8">
        <div className="max-w-md w-full">
          <div className="bg-white rounded-3xl shadow-2xl p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Tu dirección de email ha sido verificada exitosamente. Ya puedes acceder a todas las funcionalidades de AltaMedica.
            </p>
            ...
            <div className="mt-8 p-4 bg-green-50 rounded-xl border border-green-200">
              <h3 className="text-sm font-semibold text-green-800 mb-2">✅ Verificación Completada</h3>
          ...
          <div className="max-w-lg text-white">
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-blue-100">La verificación por email asegura que solo tú puedas acceder a tu información médica personal.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-blue-100">Una vez verificado, tendrás acceso completo a citas, historiales médicos y todas las funcionalidades.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-blue-100">Tu email verificado nos permite enviarte notificaciones médicas cumpliendo regulaciones de privacidad.</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-12 p-6 bg-white/10 rounded-2xl backdrop-blur-sm">
              <p className="text-sm text-blue-100 italic">
                "La verificación por email es un paso crucial para mantener la seguridad 
                de tu información médica y garantizar comunicaciones confiables."
              </p>
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
          <div className="max-w-md w-full">
            <div className="bg-white rounded-3xl shadow-2xl p-8 text-center">
              ...
              <p className="text-gray-600 mb-6">
                Hemos enviado un enlace de verificación a tu email. Haz clic en el enlace para activar tu cuenta.
              </p>
              ...
              <div className="p-4 bg-blue-50 rounded-xl border border-blue-200">
                <h3 className="text-sm font-semibold text-blue-800 mb-2">📧 ¿No recibes el email?</h3>
