...
// Wrapper cliente para renderizar widgets CSR dentro del layout (Server Component)
import ClientSidebarWidgets from './sidebar-widgets';
              ...
              <div className="mx-auto w-full max-w-[1400px] grid grid-cols-1 lg:grid-cols-[260px_minmax(0,1fr)_24px_320px] gap-4 p-4">
                ...
                <aside className="order-2 lg:order-1">
                  ...
                  <div className="lg:hidden mt-4">
                    <button className="w-full rounded-xl bg-primary-600 hover:bg-primary-700 text-white py-3 font-medium">Síntomas</button>
                  </div>
                </aside>
                ...
                <section aria-hidden className="hidden lg:block order-3">
                  <div className="sticky top-20 h-[70vh] min-h-[520px] w-6 rounded-xl border bg-white shadow-sm overflow-hidden grid place-items-center">
                    <span className="rotate-90 text-[10px] text-neutral-500">Contenedor GLB separador</span>
                  </div>
                </section>
                ...
                <aside className="order-4 space-y-4 lg:sticky lg:top-20 self-start">
                  ...
                  <section className="bg-white rounded-xl border shadow-sm p-4">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className="inline-block text-[10px] px-2 py-0.5 rounded-full bg-neutral-100 border">Perfil</span>
                    </div>
                    <div className="flex items-center gap-3">
