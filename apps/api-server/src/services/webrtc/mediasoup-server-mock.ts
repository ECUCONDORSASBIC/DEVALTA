...
export class MediaSoupServer {
  ...
  constructor(server: any) {
    console.log('⚠️  Usando MediaSoup Server MOCK - WebRTC no funcionará completamente');
    console.log('📝 Para funcionalidad completa, instala mediasoup: npm install mediasoup');
  }
  ...
  public closeRoom(roomId: string) {
    ...
    console.log(`🏠 Sala MOCK cerrada: ${roomId}`);
  }
  ...
  public createMockRoom(roomId: string) {
    ...
    console.log(`🏠 Sala MOCK creada: ${roomId}`);
  }
}