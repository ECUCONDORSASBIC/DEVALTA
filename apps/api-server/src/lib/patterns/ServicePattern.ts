  ...
  return {
    ...
    async GET(request: NextRequest, context?: { params?: any }) {
      try {
        ...
        console.error(`Error in GET ${service['collectionName']}:`, error);
    ...
    async POST(request: NextRequest) {
      try {
        ...
        console.error(`Error in POST ${service['collectionName']}:`, error);
    ...
    async PUT(request: NextRequest, context?: { params?: any }) {
      try {
        ...
        console.error(`Error in PUT ${service['collectionName']}:`, error);
    ...
    async DELETE(request: NextRequest, context?: { params?: any }) {
      try {
        ...
        console.error(`Error in DELETE ${service['collectionName']}:`, error);
  ...
  return {
    ...
    async GET(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
      try {
        ...
        console.error(`Error in GET ${service['collectionName']} by ID:`, error);
