...
export const POST = createAuthenticatedRoute(
  async (request: NextRequest, authContext) => {
    try {
      console.log('[Telemedicine] Creating new session');
      ...
      console.error('[Telemedicine] Error creating session:', error);
      return NextResponse.json(
...
export const GET = createAuthenticatedRoute(
  async (request: NextRequest, authContext) => {
    try {
      ...
      console.log(`[Telemedicine] Getting sessions for ${targetUserType}: ${targetUserId}`);
      ...
      console.error('[Telemedicine] Error getting sessions:', error);
      return NextResponse.json(
