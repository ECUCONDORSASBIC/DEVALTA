...
export const POST = createAuthenticatedRoute(
  async (request: NextRequest, authContext, { params }: { params: { id: string } }) => {
    try {
      ...
      console.log(`[Telemedicine] Adding chat message to session ${id}`);
      ...
      console.log(`[Telemedicine] Chat message added to session ${id}`);
      ...
      console.error('[Telemedicine] Error adding chat message:', error);
...
export const GET = createAuthenticatedRoute(
  async (request: NextRequest, authContext, { params }: { params: { id: string } }) => {
    try {
      ...
      console.log(`[Telemedicine] Getting chat history for session ${id}`);
      ...
      console.error('[Telemedicine] Error getting chat history:', error);
