...
export const POST = createAuthenticatedRoute(
  async (request: NextRequest, authContext) => {
    try {
      console.log('[AI Jobs] Received create job request');
      ...
      console.log(`[AI Jobs] Created job ${newJob.id} of type ${type} for patient ${patientId}`);
...
export const GET = createAuthenticatedRoute(
  async (request: NextRequest, authContext) => {
    try {
      ...
      console.log(`[AI Jobs] Retrieved ${jobs.length} jobs`);
