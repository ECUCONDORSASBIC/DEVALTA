...
export const POST = createAuthenticatedRoute(
  async (request: NextRequest, authContext) => {
    try {
      console.log('[Marketplace] Creating new company profile');
      ...
      console.log(`[Marketplace] Company created: ${company.id}`);
      ...
      console.error('[Marketplace] Error creating company:', error);
...
export const GET = createAuthenticatedRoute(
  async (request: NextRequest, authContext) => {
    try {
      ...
      console.log('[Marketplace] Getting company listings');
      ...
      console.error('[Marketplace] Error getting companies:', error);
      return NextResponse.json(
