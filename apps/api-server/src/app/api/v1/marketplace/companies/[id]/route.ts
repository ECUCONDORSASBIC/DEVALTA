...
export const GET = createAuthenticatedRoute(
  async (request: NextRequest, authContext, { params }: { params: { id: string } }) => {
    try {
      ...
      console.log(`[Marketplace] Getting company ${id}`);
      ...
      console.error('[Marketplace] Error getting company:', error);
      return NextResponse.json(
...
export const PUT = createAuthenticatedRoute(
  async (request: NextRequest, authContext, { params }: { params: { id: string } }) => {
    try {
      ...
      console.log(`[Marketplace] Updating company ${id}`);
      ...
      console.log(`[Marketplace] Company ${id} updated successfully`);
      ...
      console.error('[Marketplace] Error updating company:', error);
