...
export const POST = createAuthenticatedRoute(
  async (request: NextRequest, authContext) => {
    try {
      console.log('[Marketplace] Creating new listing');
...
export const GET = createAuthenticatedRoute(
  async (request: NextRequest, authContext) => {
    try {
      ...
      console.log('[Marketplace] Getting listings with filters:', queryParams);
      ...
      console.error('[Marketplace] Error getting listings:', error);
      return NextResponse.json(
