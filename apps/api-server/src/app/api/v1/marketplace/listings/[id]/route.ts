...
export const GET = createAuthenticatedRoute(
  async (request: NextRequest, authContext, { params }: { params: { id: string } }) => {
    try {
      ...
      console.log(`[Marketplace] Getting listing ${id}`);
      ...
      console.error('[Marketplace] Error getting listing:', error);
      return NextResponse.json(
...
export const PUT = createAuthenticatedRoute(
  async (request: NextRequest, authContext, { params }: { params: { id: string } }) => {
    try {
      ...
      console.log(`[Marketplace] Updating listing ${id}`);
      ...
      console.log(`[Marketplace] Listing ${id} updated successfully`);
...
export const DELETE = createAuthenticatedRoute(
  async (request: NextRequest, authContext, { params }: { params: { id: string } }) => {
    try {
      ...
      console.log(`[Marketplace] Deleting listing ${id}`);
      ...
      console.log(`[Marketplace] Listing ${id} deleted successfully`);
