...
export const PUT = createAuthenticatedRoute(
  async (request: NextRequest, authContext, { params }: { params: { id: string } }) => {
    try {
      ...
      console.log(`[Marketplace] Updating application ${id}`);
      ...
      console.log(`[Marketplace] Application ${id} updated to status: ${updateData.status}`);
      ...
      console.error('[Marketplace] Error updating application:', error);
...
export const GET = createAuthenticatedRoute(
  async (request: NextRequest, authContext, { params }: { params: { id: string } }) => {
    try {
      ...
      console.log(`[Marketplace] Getting application ${id}`);
      ...
      console.error('[Marketplace] Error getting application:', error);
      return NextResponse.json(
