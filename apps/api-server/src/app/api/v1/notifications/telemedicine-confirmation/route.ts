...
export const POST = createAuthenticatedRoute(
  async (request: NextRequest, authContext) => {
    try {
      console.log('[Notifications] Creating telemedicine confirmation');
      ...
      console.log(`[Notifications] Telemedicine confirmation created: ${notification.id}`);
      ...
      console.error('[Notifications] Error creating telemedicine confirmation:', error);
      return NextResponse.json(
