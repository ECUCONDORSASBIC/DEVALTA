...
export const GET = createAuthenticatedRoute(
  async (request: NextRequest, authContext, { params }: { params: { id: string } }) => {
    try {
      ...
      console.log(`[Notifications] Getting notification ${id}`);
...
export const PUT = createAuthenticatedRoute(
  async (request: NextRequest, authContext, { params }: { params: { id: string } }) => {
    try {
      ...
      console.log(`[Notifications] Updating notification ${id} with action: ${action}`);
      ...
      console.log(`[Notifications] Notification ${id} marked as ${action}`);
...
export const DELETE = createAuthenticatedRoute(
  async (request: NextRequest, authContext, { params }: { params: { id: string } }) => {
    try {
      ...
      console.log(`[Notifications] Notification ${id} deleted successfully`);
