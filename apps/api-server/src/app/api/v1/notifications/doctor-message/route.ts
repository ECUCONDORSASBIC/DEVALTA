...
export const POST = createAuthenticatedRoute(
  async (request: NextRequest, authContext) => {
    try {
      console.log('[Notifications] Creating doctor message notification');
      ...
      console.log(`[Notifications] Doctor message notification created: ${notification.id}`);
      ...
      console.error('[Notifications] Error creating doctor message:', error);
      return NextResponse.json(
