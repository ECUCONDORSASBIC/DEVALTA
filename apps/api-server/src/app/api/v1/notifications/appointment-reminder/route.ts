...
export const POST = createAuthenticatedRoute(
  async (request: NextRequest, authContext) => {
    try {
      console.log('[Notifications] Creating appointment reminder');
      ...
      console.log(`[Notifications] Appointment reminder created: ${notification.id}`);
      ...
      console.error('[Notifications] Error creating appointment reminder:', error);
      return NextResponse.json(
