...
export const POST = createAuthenticatedRoute(
  async (request: NextRequest, authContext) => {
    try {
      console.log('[Notifications] Creating medical alert');
      ...
      console.log(`[Notifications] Medical alert created: ${notification.id} (${alertType})`);
      ...
      console.error('[Notifications] Error creating medical alert:', error);
      return NextResponse.json(
