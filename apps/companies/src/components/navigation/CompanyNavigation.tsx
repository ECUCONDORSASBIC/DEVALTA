...
import { BarChart3, Briefcase, Calendar, ChartBar, UserCheck, Users } from 'lucide-react';
...
const tabs: NavTab[] = [
  { id: 'overview', label: 'Vista General', icon: BarChart3, href: '/dashboard' },
  { id: 'staff', label: 'Personal Médico', icon: UserCheck, href: '/dashboard/staff' },
  ...
  { id: 'analytics', label: 'Analíticas', icon: ChartBar, href: '/dashboard/analytics' },
