...
export function CommandPalette({ isOpen, onClose }: CommandPaletteProps) {
  ...
  const commands: MedicalCommand[] = [
    // Emergency Commands
    {
      ...
      category: 'emergency',
      shortcut: 'Ctrl+E',
      action: () => console.log('Crisis mode activated')
    },
    {
      id: 'call-emergency',
    ...
    },
    {
      ...
      category: 'emergency',
      action: () => console.log('Cardiac alert protocol')
    },
    ...
    // Redistribution Commands
    {
      ...
      shortcut: 'Ctrl+R',
      action: () => console.log('Auto redistribution started')
    },
    {
      ...
      icon: <Ambulance className="w-4 h-4 text-vscode-crisis-warning" />,
      category: 'redistribution',
      action: () => console.log('Manual redistribution interface')
    },
    {
      id: 'find-capacity',
      ...
      category: 'redistribution',
      shortcut: 'Ctrl+F',
      action: () => console.log('Finding capacity')
    },
    ...
    // Staff Commands
    {
      ...
      category: 'staff',
      action: () => console.log('Staff shortage alert')
    },
    {
      id: 'publish-job',
      ...
      category: 'staff',
      shortcut: 'Ctrl+P',
      action: () => console.log('Job published')
    },
    {
      id: 'staff-analytics',
      ...
      category: 'staff',
      action: () => console.log('Staff analytics')
    },
    ...
    // Analytics Commands
    {
      ...
      category: 'analytics',
      shortcut: 'Ctrl+M',
      action: () => console.log('Real-time metrics')
    },
    {
      id: 'generate-report',
    ...
    // System Commands
    {
      ...
      category: 'system',
      shortcut: 'Ctrl+Z',
      action: () => console.log('Zen mode toggled')
    },
    {
      id: 'system-settings',
