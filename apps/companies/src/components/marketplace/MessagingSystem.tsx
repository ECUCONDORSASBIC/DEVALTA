    ...
    const mockChats: Chat[] = [
      {
        ...
        lastMessage: {
          ...
          senderType: 'doctor',
          content: 'Gracias por la oferta. Me interesa mucho la posición de cardiólogo intervencionista.',
    ...
    if (selectedChat) {
      const mockMessages: Message[] = [
        ...
        },
        {
          ...
          senderType: 'company',
          content: 'Hola Dr. Martínez, hemos revisado su perfil y nos gustaría ofrecerle la posición de Cardiólogo Intervencionista en nuestro hospital.',
        ...
        },
        {
          ...
          senderType: 'doctor',
          content: 'Muchas gracias por considerarme. Me interesa mucho la posición. ¿Podrían proporcionarme más detalles sobre el horario y las responsabilidades específicas?',
        ...
        },
        {
          ...
          senderName: selectedChat.participants.company.name,
          senderType: 'company',
          content: 'Por supuesto. El horario incluye guardias rotativas y el foco principal será en procedimientos de angioplastia y cateterismo cardíaco. Adjunto el documento con todos los detalles.',
            ...
            <div className="mb-2 p-2 bg-white bg-opacity-20 rounded border">
              ...
              <div className="text-sm">
                ...
                <div className="text-xs opacity-90">
                  {message.metadata?.interviewDate && new Date(message.metadata.interviewDate).toLocaleString('es-ES')}
                </div>
              </div>
            </div>
          )}
