...
import { formatMedicalDate, formatShortDate, getTimeUntilAppointment } from '../utils';
      ...
      <div className="flex justify-between items-start mb-3">
        <div className="flex items-center space-x-2">
          ...
          <div>
            ...
            {timeUntil && (
              <p className="text-xs text-gray-500">in {timeUntil}</p>
            )}
          </div>
        </div>
