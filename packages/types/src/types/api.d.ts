import { User, UserRole, SearchFilters, DateRange, AppointmentType, AppointmentStatus, Medication, MedicalRecordType, Priority, LabTestResult, FileUpload, AnalyticsData } from "./base";
