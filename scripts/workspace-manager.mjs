...
/**
 * Script de gestión para el workspace organizado por categorías
...
function showHelp() {
  ...
  console.log('  node scripts/workspace-manager.mjs dev:doctors');
  console.log('  node scripts/workspace-manager.mjs build:patients');
  console.log('  node scripts/workspace-manager.mjs test:all');
  console.log('');
}
