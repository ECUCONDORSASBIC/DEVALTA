...
function showHelp() {
  ...
  console.log('  node scripts/dev-workspace.js dev:doctors');
  console.log('  node scripts/dev-workspace.js build:patients');
  console.log('  node scripts/dev-workspace.js test:all');
  console.log('');
}
